            ...
            <div className="w-[100%] fixed flex justify-center py-24 mt-12">
                <div className="lg:w-[450px] md:w-[400px] h-[480px] bg-black/75 py-16 lg:px-9 md:px-8">
                    ...
                    <form className="flex flex-col p-7">
                        ...
                        <button className="bg-red-600 mt-7 py-3 rounded font-bold hover:scale-105 duration-300 cursor-not-allowed">Sign up</button>
                        ...
                        <p><span className="text-gray-500">Already a Netflix Mamber?</span>{' '}
